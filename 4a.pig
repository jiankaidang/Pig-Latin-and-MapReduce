...
login_group = GROUP users_join_tweets BY login;
...
at_least_two_tweets_names = FOREACH at_least_two_tweets GENERATE group;

-- Use the default Pig output function to store the results.
STORE at_least_two_tweets_names INTO '4a.result';